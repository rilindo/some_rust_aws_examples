...
async fn get_topic_attributes(client: &SnsClient, get_topic_attributes_request: GetTopicAttributesInput) -> GetTopicAttributesResponse {

    let resp = client.get_topic_attributes(get_topic_attributes_request).await;
    return resp.unwrap();
