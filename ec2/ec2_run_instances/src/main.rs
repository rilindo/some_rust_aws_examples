...
use rusoto_ec2::{Ec2, Ec2Client, Reservation, RunInstancesRequest};
...
fn main() {
    ...
    let matches = App::new("Example Run Instances Using Rust")
        ...
        .arg(
            Arg::with_name("security_group_id")
                .short("g")
