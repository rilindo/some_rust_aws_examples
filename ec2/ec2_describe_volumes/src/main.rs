...
async fn describe_volumes(client: &Ec2Client, describe_volumes_request: DescribeVolumesRequest) -> DescribeVolumesResult {
            ...
            for v in volumes {
                match v.volume_id {
                    Some(volume_id) => {
                        ...
                        println!("Volume ID: {}, Volume Type: {}, Volume Size: {}, Snapshot ID: {}",
                                                                                            volume_id,
                                                                                            volume_type,
                                                                                            volume_size,
                                                                                            snapshot_id)
